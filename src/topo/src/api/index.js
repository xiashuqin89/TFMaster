...
console.log(window.PROJECT_CONFIG.SITE_URL + process.env.BK_AJAX_URL_PREFIX, '...')
// axios 实例
const axiosInstance = axios.create({
    baseURL: window.PROJECT_CONFIG.SITE_URL + process.env.BK_AJAX_URL_PREFIX,
...
export function injectCSRFTokenToHeaders () {
    const token = process.env.BK_OAUTH2_TOKEN;
